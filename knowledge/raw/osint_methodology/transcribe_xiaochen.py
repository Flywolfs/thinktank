...
if __name__ == "__main__":
    ...
    videos = [
        ("v7_xiaochen_jfz", audio_dir / "v7_xiaochen_jfz"),
        ("v8_xiaochen_fund", audio_dir / "v8_xiaochen_fund"),
        ("v9_xiaochen_follow", audio_dir / "v9_xiaochen_follow"),
    ]
